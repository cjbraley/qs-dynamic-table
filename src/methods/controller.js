...
export default function (app, qlik) {
	return [
		...
		function ($scope, $element) {
			...
			$scope.setInterColumnSortOrder = function(){

				let qInterColumnSortOrder = $scope.table.table.qHyperCube.qEffectiveInterColumnSortOrder;
